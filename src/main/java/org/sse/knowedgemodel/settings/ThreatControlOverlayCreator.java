...
public class ThreatControlOverlayCreator {
    ...
    /*private void loadThreatControlLists() throws ParserConfigurationException, SAXException, IOException {
        ...
        attackerThreatControlList = ThreatModelConfig.loadThreatControls();

        DefensiveControlConfig defensiveControlConfig = new DefensiveControlConfig();
        defensiveThreatControlList = defensiveControlConfig.loadThreatControls();
    }*/
