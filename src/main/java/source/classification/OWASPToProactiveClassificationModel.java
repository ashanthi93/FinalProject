...
public class OWASPToProactiveClassificationModel {
    ...
    public void createMapping() throws ParserConfigurationException, SAXException, IOException {
        ...
        for (String key : OWASP_proactives_mapping.keySet()){
            ...
            OWASPToProactiveMapping mappingProactive = this.createOWASPToProactiveMapping(key, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10);
    ...
    private OWASPToProactiveMapping createOWASPToProactiveMapping(String bugType, Boolean c1, Boolean c2, Boolean c3, Boolean c4, Boolean c5, Boolean c6, Boolean c7, Boolean c8, Boolean c9, Boolean c10){
